...
\begin{figure}[H] % Hで「ここに出せ」と指定（\usepackage{here}が必要）
  \centering
  \includegraphics[width=0.6\linewidth]{242C2016_NaoOkumura_3_4_a.eps} % 拡張子付きOK（dvipdfmx前提）
\end{figure}

\begin{figure}[H] % Hで「ここに出せ」と指定（\usepackage{here}が必要）
  \centering
  \includegraphics[width=0.6\linewidth]{242C2016_NaoOkumura_3_4_b.eps} % 拡張子付きOK（dvipdfmx前提）
\end{figure}

\begin{figure}[H] % Hで「ここに出せ」と指定（\usepackage{here}が必要）
  \centering
  \includegraphics[width=0.6\linewidth]{242C2016_NaoOkumura_3_4_c.eps} % 拡張子付きOK（dvipdfmx前提）
\end{figure}

\begin{figure}[H] % Hで「ここに出せ」と指定（\usepackage{here}が必要）
  \centering
  \includegraphics[width=0.6\linewidth]{242C2016_NaoOkumura_3_4_d.eps} % 拡張子付きOK（dvipdfmx前提）
\end{figure}
